...
export async function POST(req: NextRequest) {
  try {
    ...
    // Sanitize the file name to prevent path traversal and clean up whitespace/special chars
    ...
    try {
      // Security: Do NOT trust user-provided file.type. Infer strictly from validated extension.

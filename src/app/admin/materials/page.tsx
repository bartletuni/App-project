                  ...
                  {editingId === m.id ? (
                    <div className="flex-1 flex gap-3 mr-4">
                      ...
                      <button
                        ...
                        className="text-green-600 hover:bg-green-50 p-2 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
                        title="Save changes"
                      ...
                      <button
                        ...
                        className="text-gray-400 hover:bg-gray-100 p-2 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500"
                    ...
                    <>
                      ...
                      <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                        ...
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"

                    ...
                    <>
                      ...
                      <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500"
                          title="Edit material"
                        ...
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-red-500"

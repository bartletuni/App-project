            ...
            <div className="px-6 py-6 sm:p-8">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <dd className="mt-1 text-sm text-gray-900 font-semibold flex items-center gap-2">
                            {selectedRequest.invoiceNumber ? selectedRequest.invoiceNumber : <span className="text-gray-400 font-normal">Pending</span>}
                        </dd>
                    </div>
                </dl>
            </div>

    ...
    <Panel className="p-6 sm:p-7 rounded-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <label htmlFor="fileUpload" className="flex cursor-pointer items-center gap-3 border border-dashed border-clay-500/30 px-4 py-3 rounded-md hover:border-clay-400 hover:bg-clay-500/5 peer-focus-visible:ring-2 peer-focus-visible:ring-clay-500/40 peer-focus-visible:border-clay-400 peer-focus-visible:outline-none transition-colors">

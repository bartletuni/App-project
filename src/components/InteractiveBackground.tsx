  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      update(t: number) {
        ...
        const J = 0.55;
        // Ease toward home (0.03 = half the previous 0.06 for a slower assembly).
        this.x += (tx - this.x) * 0.03 + (Math.random() - 0.5) * J + this.vx;
        this.y += (ty - this.y) * 0.03 + (Math.random() - 0.5) * J + this.vy;
